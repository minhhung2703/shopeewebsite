...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <form action="" method="post">
            ...
            <button type="submit" class1="btn btn-primary">Calculation</button>
            <div class="form-group">
                <input type="number" class="form-control" placeholder="Kết quả" disable="" value="<?php if(isset($sum)) echo $sum; ?>">
            </div>
        </form>
